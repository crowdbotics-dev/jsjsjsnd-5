"""
Django settings for jsjsjsnd_5 project.
...
WSGI_APPLICATION = 'jsjsjsnd_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jsjsjsnd_5 API",
    "DESCRIPTION": "API documentation for jsjsjsnd_5 App",
    "VERSION": "v1",
}
